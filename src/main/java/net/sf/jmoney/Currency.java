 ...
 * SDK is to complicated. Therefore we provide a simpler model which is not
 * based upon locales but upon the ISO 4217 currencies.
 */
public class Currency implements Comparable<Object> {

	public static final ResourceBundle NAME = ResourceBundle.getBundle("net.sf.jmoney.resources.Currency");
	public static final int MAX_DECIMALS = 4;
	private static final short[] SCALE_FACTOR = { 1, 10, 100, 1000, 10000 };
	private static Hashtable<String, Currency> currencies = null;
