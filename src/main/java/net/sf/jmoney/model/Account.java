...
public class Account implements Category, Serializable {
	...
	public long parseAmount(String amountString) {
		...
		return Math.round(amount.doubleValue() * getCurrency().getScaleFactor());
	}
	...
	/**
	 * @param m
	 *            the minimal balance which may be null.
	 */
	...
	/**
	 * @param anAbbrevation
	 *            the abbrevation of this account.
	 */
	...
	public String getFullCategoryName() {
		return Constants.LANGUAGE.getString("TransferCategory.name") + ":" + getCategoryName();
	}
