...
public class SimpleCategory extends AbstractCategory {
	...
	private ExpTypes categoryType;

	public String getCategoryType() {
		return categoryType == null ? ExpTypes.Expense.name() : categoryType.name();
	}

	public void setCategoryType(String typeName) {
		ExpTypes type = ExpTypes.valueOf(typeName);
	...
	public SimpleCategory(String aCategoryName) {
		...
		setCategoryType(ExpTypes.Default.toString());
	}
